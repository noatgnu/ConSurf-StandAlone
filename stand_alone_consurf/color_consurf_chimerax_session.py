...
def colour_consurf(filename, output_file):
    ...
    rc(session, "color name cons9 63,16,37")
    rc(session, "color name cons8 94,49,67")
    rc(session, "color name cons7 98,78,86")
    rc(session, "color name cons6 98,92,96")
    rc(session, "color name cons5 100,100,100")
    rc(session, "color name cons4 84,94,94")
    rc(session, "color name cons3 65,86,90")
    rc(session, "color name cons2 29,69,75")
    rc(session, "color name cons1 4,49,51")
    rc(session, "color name cons10 100,100,59")
